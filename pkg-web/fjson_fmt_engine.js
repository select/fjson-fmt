/* @ts-self-types="./fjson_fmt_engine.d.ts" */
 ...
 * @returns {string}
 */
export function format(input, options_json) {
    let deferred4_0;
    let deferred4_1;
    try {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./fjson_fmt_engine_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('fjson_fmt_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
